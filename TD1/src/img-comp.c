...
int main(const int argc, const char **argv)
{
    ...
    img_set_pixels(output, input_r->width, input_r->height, input_r->fmt, (void *)channel_compose(input_r->pixels, input_g->pixels, input_b->pixels, input_r->width * input_r->height));
